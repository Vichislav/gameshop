...
function GridItem({ arrPosts }: GridProps) {
  ...
  const [delta] = useState<number>(50)
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      {botBtn && (
        <div className="w-[50%] flex flex-row items-center justify-center p-2 gap-1 ">
          ...
          <div
            ref={wrapRef}
            className="relative w-[200px] flex flex-row justify-between overflow-hidden"
          >
            <div
              ref={containerRef}
              className="relative flex flex-row transition duration-300 ease-in-out"
            >
              {botBtn.map((item) => (
                <button
