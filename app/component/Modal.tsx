...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children, big }) => {
    if (!isOpen) {
        return null;
    }
    ...
    return ReactDOM.createPortal(
        <div className=' fixed top-0 left-0 right-0 bottom-0 bg-bgModal flex justify-center items-center' onClick={onClose}>
            <div className={clsx(big ? "w-[60%]" : "w-[40%]",'bg-white p-[20px] border-r-[5px] h-[40vh] rounded-[15px]')} onClick={handleInnerClick}>
