...
export default function Task4() {
  ...
  const [borederChange, setBorderChange] = useState<boolean[]>([
    false,
    false,
    false,
  ])
  ...
  return (
    <div
      className="w-[100%] lg:w-[80%] flex flex-col  items-center gap-[10px] border-2  border-black rounded-lg"
    ...
    >
      <div className=" w-full text-center bg-[#dde4ec] rounded-t-[5px]">
        <p className="text-sm px-2 py-1">
          Расположите операторы в выражении таким образом, чтобы оно возвращало{' '}
