...
export default function Task3() {
    ...
    useEffect(() => {
        //
        const expression = `7&&2==2||6`;
        const currentSolving = `7${data[0]}2${data[1]}2${data[2]}6`
    ...
    return (
        ...
        <div className='w-[100%] lg:w-[80%] flex flex-col items-center gap-[10px] border-2  border-black rounded-[8px] '
            style={{ backgroundColor: solving ? '#7efca0' : 'white' }}>
             ...
             <p className='text-sm px-1'>Расположите операторы в выражении таким образом, чтобы оно возвращало <span className='text-green-500'>true</span></p>
            </div>   
