...
export default function EventTask3() {

    const [solving, setSolving] = useState<boolean>(false)// верно ли решено задание
    const [data, setData] = useState<string[]>(['...', '...', '...', '...', '...', '...', '...']);
    const [activ, setActiv] = useState<boolean[]>([true, true, true, true, true, true, true])
    ...
    const onStart = () => {
        ...
        setActiv(activ => {
            const newArr = [true, true, true, true, true, true, true]
            return newArr
        })
        setCount(0)
    }
    ...
    useEffect(() => {
        //
        const expression = `1635274`;
        const currentSolving = `${data[0]}${data[1]}${data[2]}${data[3]}${data[4]}${data[5]}${data[6]}`
...
//bg-[#c0bfbf] setTimeout(() => console.log(2)); Promise.resolve().then(() => console.log(3))
    return (
        <div className='w-[100%] lg:w-[80%] flex flex-col items-center gap-[10px] border-2  border-black rounded-[8px] pb-2'
                ...
                <div className="flex flex-col text-[10px] leading-8 md:text-sm lg:text-base">
                    ...
                    <div className=" cursor-pointer  "
                      ...
                      onClick={()=>dataHandler(2)}>
                        <p className=' px-2 '>
                            <span className="text-green-800">Promise</span>
                            .
                            ...
                            <span className='text-yellow-400'>&#41;</span>
                            .
                            <span className='text-yellow-500'>catch</span>
                            <span className='text-yellow-400'>&#40;</span>
                            <span className='text-blue-500'>console</span>
                            .
                            <span className='text-yellow-500'>log</span>
                    ...
                    <div className=" cursor-pointer  "
                      ...
                      onClick={()=>dataHandler(3)}>
                        <p className=' px-2 '>
                            <span className='text-blue-800'>new &nbsp;</span>
                            <span className="text-green-800">Promise</span>
                            <span className='text-yellow-400'>&#40;</span>
                            <span className='text-yellow-500'>resolve</span>
                            <span>&nbsp;=&gt;&nbsp;</span>
                            <span className='text-yellow-500'>setTimeout</span>
                            <span className='text-purple-700'>&#40;</span>
                            <span className='text-yellow-500'>resolve &nbsp;</span>
                        ...
                        <p className=' pl-4' >
                            ...
                            .
                            <span className='text-yellow-500'>then</span>
                            <span className='text-yellow-400'>&#40;</span>
                            <span className='text-purple-700'>&#40;</span>
                            <span className='text-purple-700'>&#41;</span>
                            <span>&nbsp;=&gt;&nbsp;</span>
                    ...
                    <div className=" cursor-pointer "
                      style={{ backgroundColor: activ[5] ? 'white' : '#c0bfbf' }}
                      onClick={()=>dataHandler(5)}>
                         <p className=' px-2 '>
                            <span className='text-blue-500'>console</span>
                            .
                            <span className='text-yellow-500'>log</span>
                    ...
                    <div className=" cursor-pointer  "
                      style={{ backgroundColor: activ[6] ? 'white' : '#c0bfbf' }}
                      onClick={()=>dataHandler(6)}>
                       <p className=' px-2 '>
                            <span className='text-yellow-500'>setTimeout</span>
                            <span className='text-yellow-400'>&#40;</span>
                            <span className='text-purple-700'>&#40;</span>
